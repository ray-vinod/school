...
namespace School.Migrations
{
    ...
    [Migration("20180619120607_Relation")]
            ...
            modelBuilder.Entity("School.Models.Student", b =>
                {
                    b.HasOne("School.Models.Address", "Address")
                        .WithOne("Student")
                        .HasForeignKey("School.Models.Student", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("School.Models.Contact", "Contact")
                        .WithOne("Student")
                        .HasForeignKey("School.Models.Student", "ContactId")
                        .OnDelete(DeleteBehavior.Cascade);
